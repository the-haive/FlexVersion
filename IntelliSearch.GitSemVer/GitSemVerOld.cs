...
namespace IntelliSearch.GitSemVer
{
    ...
    public class GitSemVerOld
    {
        ...
        public GitSemVerOld(Settings settings, string repoPath = null)
        {
        ...
        /// <param name="repoPath"></param>
        public GitSemVerOld(string settingsAsYamlFilePath = null, string repoPath = null)
        {
            _repoPath = repoPath ?? Environment.CurrentDirectory;
        ...
        public ResultOld Analyze()
        {
            var result = new ResultOld();
